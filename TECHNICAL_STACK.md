...
- **Chart.js**: JavaScript charting library for data visualization in admin analytics
- **Socket.io Client**: For real-time updates in the analytics dashboard
- **QRCode Library**: JavaScript library for generating QR codes on the frontend
...
- **json2csv**: JSON to CSV conversion for data exports
